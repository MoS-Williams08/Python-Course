...
# (save in variable number) and then save in result_2 variable your name repeated as many times
# as number_1 is (use loops)
...
# Ex. 3
# Enter a random string, which includes only digits. Write code which find a sum of digits in this string
# and save it into result_3 variable
